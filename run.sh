...
declare data_sets=("exp1" ) #"exp1"  "exp2-benchmark" #"exp2"
...
for data_set in "${data_sets[@]}"; do
    ...
    case "$data_set" in
        "exp1") models=("rndPG"); sim_model='ecPG_sim';; # "rmPG" "caPG" "ecPG" "l2PG" "rmPG" "caPG" "ecPG" "LC" "MA" "l1PG" "l2PG" "dcPG";;
    ...
    #     models=("MA" "ACL") # 
    #     other_models=("ecPG_fea" "l2PG_fea" "rmPG_fea" "caPG_fea" "LC" "MA" "ACL" "l1PG_fea") #"ecPG_fea" "l2PG_fea" "rmPG_fea" "caPG_fea" "LC" "MA" "ACL" "l1PG_fea"
    #     for model in "${models[@]}"; do
